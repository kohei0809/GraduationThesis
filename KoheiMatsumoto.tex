...
\subsubsection{経路生成戦略}\label{route_strategy}
  ...
  \begin{figure}
    \begin{minipage}{0.48\hsize}
      \centering
      \includegraphics[width=0.99\hsize]{figures/ExpReal_ESgroup_0.png}
      \subcaption{例1}
      \label{subfig:expReal_ES_0}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\hsize}
      \centering
      \includegraphics[width=0.99\hsize]{figures/ExpReal_ESgroup_7.png}
      \subcaption{例2}
      \label{subfig:expReal_ES_7}
    \end{minipage}
    \caption{ES-groupにおけるイベント量の予測値と真値の関係(実験7)}
    \label{fig:expReal_ES}
  \end{figure}

  \begin{figure}
    \begin{minipage}{0.48\hsize}
      \centering
      \includegraphics[width=0.99\hsize]{figures/ExpReal_Bgroup_2.png}
      \subcaption{例1}
      \label{subfig:expReal_B_0}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\hsize}
      \centering
      \includegraphics[width=0.99\hsize]{figures/ExpReal_Bgroup_6.png}
      \subcaption{例2}
      \label{subfig:expReal_B_7}
    \end{minipage}
  ...
  図\ref{fig:expReal_B}でもイベント量の変化の仕方は予測できているが，
  予測値と実際のイベント量との差が比較的大きくなっている．
  また，図\ref{fig:expReal_ES}とは逆に，
