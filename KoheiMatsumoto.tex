...
\subsubsection{経路生成戦略}\label{route_strategy}
  ...
  それぞれ3,600ステップごとの$D(s)$と$C(s)$の時間推移を示したものである
  なお，$\Dreq$は$0 \sim 2,000,000$ステップと$4,000,000 \sim 6,000,000$ステップでは1,000であり，
  $4,000,000 \sim 6,000,000$ステップでは600と設定している．
  つまり，エージェントは$0 \sim 2,000,000$ステップと$4,000,000 \sim 6,000,000$ステップでは$D(s) \leq 3,600,000 (= 3600\Dreq)$
  を保ち，$4,000,000 \sim 6,000,000$ステップでは$D(s) \leq 2,160,000 (= 3600\Dreq)$を保つことが要求条件であることに注意されたい．
  ...
  {\em Pausing}による待機時間の関係をまとめた散布図が図
  ...
  このことから，この環境では13台のエージェントで要求品質を満たすことができたと考えられる．
  \par
