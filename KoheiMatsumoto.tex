...
\subsubsection{経路生成戦略}
  ...
  エージェントがエネルギー節約行動をとらない手法であるAMTDS\cite{Yoneda2013}やAMTDS/EDC\cite{Sugiyama2019}や，
  ...
  この環境は図\ref{subfig:env1}と比べると，環境全体のイベント発生量は少ないが，
  ...
  \subsection{AMTDS/ERについての実験結果・考察}
  \label{result_ER}
